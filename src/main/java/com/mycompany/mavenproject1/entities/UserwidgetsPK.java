 ...
 */
@Embeddable
public class UserwidgetsPK implements Serializable {
    ...
    public UserwidgetsPK() {
    }

    public UserwidgetsPK(String customerno, String channelid, BigInteger pageid) {
    ...
    public boolean equals(Object object) {
        ...
        if (!(object instanceof UserwidgetsPK)) {
            return false;
        }
        UserwidgetsPK other = (UserwidgetsPK) object;
    ...
    public String toString() {
        return "com.mycompany.mavenproject1.entities.UserwidgetsPK[ customerno=" + customerno + ", channelid=" + channelid + ", pageid=" + pageid + " ]";
    }
